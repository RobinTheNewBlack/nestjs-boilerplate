...
export class SalesTransactionController {
    ...
    @ApiResponse({ status: 201, description: 'Sales transaction created successfully' })
    ...
    @ApiResponse({ status: 200, description: 'Sales transaction updated successfully' })
    @ApiResponse({ status: 400, description: 'Validation failed' })
    @ApiResponse({ status: 404, description: 'Sales transaction not found' })
    ...
    @ApiResponse({ status: 204, description: 'Sales transaction deleted successfully' })
    @ApiResponse({ status: 404, description: 'Sales transaction not found' })
